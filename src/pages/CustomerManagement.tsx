    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-white dark:from-gray-900 dark:to-gray-800">
      <div className="p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <Card className="lg:col-span-2 p-5 bg-white dark:bg-gray-800 shadow-md">
                    ...
                    <TableBody>
                      {filteredCustomers.map((customer, i) => {
                        ...
                        return (
                          <TableRow 
                            key={i}
                            className={selectedCustomer?.customer_name === customer.customer_name ? "bg-purple-50 dark:bg-gray-700" : ""}
          ...
          <div className="lg:col-span-1">
            {selectedCustomer ? (
              <CustomerDetailsPanel 
                ...
                onEdit={() => {/* Edit customer functionality */}} 
              />
            ) : (
              <Card className="h-full p-8 flex flex-col items-center justify-center text-center text-muted-foreground">
      ...
      <AddCustomerDialog
        ...
        onSuccess={() => {
          ...
          // Refresh customer data will be handled by React Query
        }}
      />
    </div>
  );
